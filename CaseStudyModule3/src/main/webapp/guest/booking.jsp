                            ...
                            <form class="row g-3" method="post">
                                <div class="col-md-6">
                                    <c:if test='${requestScope["checkName"] == "success"}'>
                                        ...
                                        <input type="text" class="form-control is-valid" id="validationServer01" placeholder=${requestScope["fullName"]} name="guestName" required>
                                    ...
                                    <c:if test='${requestScope["checkName"] == "false"}'>
                                        <label for="validationDefault01" class="form-label">Guest name</label>
                                        <input type="text" class="form-control is-invalid" id="validationServer01" placeholder=${requestScope["fullName"]} name="guestName" required>
                                ...
                                <div class="col-md-6">
                                    <c:if test='${requestScope["checkPhoneNumber"] == "success"}'>
                                        ...
                                        <input type="text" class="form-control is-valid" id="validationServer02" placeholder=${requestScope["phoneNumber"]} name="phoneNumber" required>
                                        <div class="valid-feedback">
                                            Phone Number Valid!
                                        </div>
                                    </c:if>
                                    <c:if test='${requestScope["checkPhoneNumber"] == "false"}'>
                                        <label for="validationDefault02" class="form-label">Guest Phone Number</label>
                                        <input type="text" class="form-control is-invalid" id="validationServer02" placeholder=${requestScope["phoneNumber"]} name="phoneNumber" required>
                                ...
                                <div class="col-md-6">
                                    <c:if test='${requestScope["checkArrivalDate"] == "success"}'>
                                        ...
                                        <input type="date" class="form-control is-valid" id="validationServer03" placeholder=${requestScope["arrivalDate"]} name="arrivalDate" required>
                                        <div class="valid-feedback">
                                            Arrive Date Valid!
                                        </div>
                                    </c:if>
                                    <c:if test='${requestScope["checkArrivalDate"] == "false"}'>
                                        <label for="validationDefault03" class="form-label">Arrive Date</label>
                                        <input type="date" class="form-control is-invalid" id="validationServer03" placeholder=${requestScope["arrivalDate"]} name="arrivalDate" required>
                                    ...
                                    <c:if test='${requestScope["checkArrivalDate"] == null}'  >
                                        <label for="validationDefault03" class="form-label">Arrive Date</label>
                                        <input type="date" class="form-control" id="validationDefault03" placeholder="12-12-2021" name="arrivalDate" required>
                                    </c:if>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <c:if test='${requestScope["checkArrivalDate"] == "success"}'>
                                        ...
                                        <input type="date" class="form-control is-valid" id="validationServer04" placeholder=${requestScope["departureDate"]} name="departureDate" required>
                                        <div class="valid-feedback">
                                    ...
                                    <c:if test='${requestScope["checkArrivalDate"] == "false"}'>
                                        <label for="validationDefault04" class="form-label">Departure Date</label>
                                        <input type="date" class="form-control is-invalid" id="validationServer04" placeholder=${requestScope["departureDate"]} name="departureDate" required>
                                    ...
                                    <c:if test='${requestScope["checkDepartureDate"] == null}'  >
                                        <label for="validationDefault04" class="form-label">Departure Date</label>
                                        <input type="date" class="form-control" id="validationDefault04" placeholder="15-12-2021" name="departureDate" required>
                                    </c:if>
                                </div>
                                ...
                                <div class="col-md-9">
                                    <c:if test='${requestScope["checkGuaranteeFee"] == "success"}'>
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control is-valid" id="validationServer01Username" placeholder=${requestScope["outPutGuaranteeFee"]} name="guaranteeFee" style="text-align: right"  required>
                                    ...
                                    <c:if test='${requestScope["checkGuaranteeFee"] == "false"}'>
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control is-invalid" id="validationServer02Username" placeholder=${requestScope["outPutGuaranteeFee"]} name="guaranteeFee" style="text-align: right" required>
