                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item" onclick='window.location.href="/system?action=showRoomList"'>
                                    <i class="fas fa-bed"></i>
                                    <span class= "active_point">Room List</span>
                                </li>
                        ...
                        <div class="card-body">
                            <form class="row g-3" method="post">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="validationDefault06" value=${room.getRoomNumber()} name="roomNumber" readonly>
                                </div>
                                ...
                                <div class="col-10">
                                    <c:if test='${requestScope["message"] == "false"}'>
                                        <div class="alert alert-danger" role="alert" style="margin-left: 20px">
                                            <span>Check-Out Fail! please follow Instructor!</span>
                                        </div>
                                    </c:if>
                                </div>
                            </form>
